            ...
            <div class="container-fluid p-4" style="min-height: 100vh;">
                ...
                <div class="status">
                    ...
                    <form action="/admin/make-payment" method="post">
                        ...
                        <div class="row ">
                            <div class="col-6">
                                ...
                                <div class="p-2 ">
                                    ...
                                    <input type="number" id="amount" name="amount" value="{{$member->amount}}" placeholder="Monto" class="d-block w-100 p-2" required>
                                </div>
                                <div class="p-2">
                                ...
                                <div class="p-2">
                                    ...
                                    <select name="status" id="status">
                                        <option value="active" @if ($member->status == "active") {{"selected"}} @endif>Activo</option>
                                        <option value="pending" @if ($member->status == "pendding") {{"selected"}} @endif>Pendiente</option>
                                        <option value="expired" @if ($member->status == "expired") {{"selected"}} @endif>Expirado</option>
                        ...
                        <div class="p-2">
                            <a class="btn btn-info" href="{{ route('payment.voucher', $member->id) }}" target="_blank">
                                Generar Voucher
                            </a>
                        </div>
