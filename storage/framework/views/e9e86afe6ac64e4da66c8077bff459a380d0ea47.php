...
<body>
    <div class="voucher">
        ...
        <div class="header">
            ...
            <p style="margin: 0; font-size: 16px;">Fecha: <?php echo e($date); ?></p>
        </div>
        
        <div class="details">
            <div class="detail-row">
                <div class="detail-label">ID de Transacción:</div>
                <div><?php echo e($transactionId); ?></div>
            </div>
            <div class="detail-row">
                <div class="detail-label">Nombre del Miembro:</div>
                <div><?php echo e($member->full_name); ?></div>
            </div>
            <div class="detail-row">
                <div class="detail-label">Servicio Contratado:</div>
                <div><?php echo e($member->services); ?></div>
            </div>
            <div class="detail-row">
                <div class="detail-label">Plan:</div>
                <div><?php echo e($member->plan); ?> Mes/es</div>
            </div>
            <div class="detail-row">
                <div class="detail-label">Monto Pagado:</div>
                <div style="font-weight: bold; color: #006600;">$<?php echo e(number_format($member->amount, 2)); ?></div>
            </div>
            <div class="detail-row">
                <div class="detail-label">Fecha de Pago:</div>
                <div><?php echo e($member->paid_date ?? date('Y-m-d')); ?></div>
            </div>
            <div class="detail-row">
                <div class="detail-label">Estado:</div>
                <div style="color: <?php echo e($member->status == 'active' ? '#006600' : '#cc0000'); ?>; font-weight: bold;">
...
</html><?php /**PATH C:\Users\Asus\Desktop\gym-system-main - copia\resources\views/voucher.blade.php ENDPATH**/ ?>