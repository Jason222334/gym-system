            ...
            <div class="container-fluid p-4" style="min-height: 100vh;">
                ...
                <div class="status">
                    ...
                    <form action="/admin/make-payment" method="post">
                        ...
                        <div class="p-2">
                            <a class="btn btn-info" href="<?php echo e(route('payment.voucher', $member->id)); ?>" target="_blank">
                                Generar Voucher
                            </a>
                        </div>
...
<?php echo $__env->make("footer", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\Desktop\gym-system-main - copia\resources\views/paymentData.blade.php ENDPATH**/ ?>