                ...
                <table class="table table-hover table-bordered text-center" style=" font-weight:bold;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($member->plan); ?> month/s</td>
                            <?php if($member->status == "pending"): ?>
                            <td style="color:rgb(231, 115, 19)">
                                <?php echo e($member->status); ?>

                                <a class="btn btn-outline-primary" href="/admin/activate-member/<?php echo e($member->id); ?>" >activate</a>
                            </td>
...
<?php echo $__env->make("footer", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\Desktop\gym-system-main\resources\views/admin/members/memberStatus.blade.php ENDPATH**/ ?>